...
while True:
    ...
    for contour in contours:
        ...
        if area >= 100:
            ...
            sredistesum[0] += srediste[0]
            sredistesum[1] += srediste[1]
    ...
    avgSrediste = (sredistesum[0]/brojac, sredistesum[1]/brojac)
    cv2.moveWindow("my WEBcam", int(2*avgSrediste[0]), int(2*avgSrediste[1]))
